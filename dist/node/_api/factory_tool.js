...
var AListOfDownloadableFactoryToolVersions_ = (function () {
    function AListOfDownloadableFactoryToolVersions_() {
    }
    return AListOfDownloadableFactoryToolVersions_;
}());
exports.AListOfDownloadableFactoryToolVersions_ = AListOfDownloadableFactoryToolVersions_;
var FactoryToolDownload = (function () {
    function FactoryToolDownload() {
    }
    return FactoryToolDownload;
}());
exports.FactoryToolDownload = FactoryToolDownload;
...
var DefaultApi = (function () {
    ...
    DefaultApi.prototype.downloadsMbedFactoryProvisioningPackageGet = function (os, callback) {
        var localVarPath = this.basePath + '/downloads/mbed_factory_provisioning_package';
        var queryParameters = {};
    ...
    DefaultApi.prototype.downloadsMbedFactoryProvisioningPackageInfoGet = function (callback) {
        var localVarPath = this.basePath + '/downloads/mbed_factory_provisioning_package/info';
        var queryParameters = {};
        var headerParams = this.extendObj({}, this.defaultHeaders);
        var formParams = {};
        var useFormData = false;
