...
var Device = (function () {
    ...
    */
    Device.prototype.getResources = function (callback) {
        var _this = this;
        return pg(function (done) {
            _this._api.endpoints.v2EndpointsEndpointNameGet(_this.id, function (error, data) {
                ...
                var resources = data.map(function (resource) {
                    resource.device = _this;
                    return new resource_1.Resource(_this._api, resource);
                });
                done(null, resources);
            });
        }, callback);
    ...
    */
    Device.prototype.getSubscriptions = function (callback) {
