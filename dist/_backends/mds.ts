...
export class DefaultApi {
     ...
     */
    public v2NotificationCallbackDelete () : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     */
    public v2NotificationCallbackGet () : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/v2/notification/callback';
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
        let formParams: any = {};
...
export class EndpointsApi {
     ...
     */
    public v2EndpointsEndpointNameGet (endpointName: string) : Promise<{ response: http.IncomingMessage; body: Array<Resource>;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: Array<Resource>;  }>((resolve, reject) => {
            request(requestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public v2EndpointsGet (type?: string) : Promise<{ response: http.IncomingMessage; body: Array<Endpoint>;  }> {
...
export class NotificationsApi {
     ...
     */
    public v2NotificationCallbackPut (webhook: Webhook) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/v2/notification/callback';
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
        let formParams: any = {};
     ...
     */
    public v2NotificationPullGet () : Promise<{ response: http.IncomingMessage; body: NotificationMessage;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: NotificationMessage;  }>((resolve, reject) => {
            request(requestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
...
export class ResourcesApi {
     ...
     */
    public v2EndpointsEndpointNameResourcePathDelete (endpointName: string, resourcePath: string, noResp?: boolean) : Promise<{ response: http.IncomingMessage; body: AsyncID;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: AsyncID;  }>((resolve, reject) => {
            request(requestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public v2EndpointsEndpointNameResourcePathGet (endpointName: string, resourcePath: string, cacheOnly?: boolean, noResp?: boolean) : Promise<{ response: http.IncomingMessage; body: AsyncID;  }> {
        const localVarPath = this.basePath + '/v2/endpoints/{endpointName}/{resourcePath}'
            .replace('{' + 'endpointName' + '}', String(endpointName))
            .replace('{' + 'resourcePath' + '}', String(resourcePath));
        let queryParameters: any = {};
     ...
     * @param noResp **Non-confirmable requests**  All resource APIs have the parameter noResp. If you make a request with noResp&#x3D;true, mbed Cloud Connect makes a CoAP non-confirmable request to the device. Such requests are not guaranteed to arrive in the device, and you do not get back an async-response-id.  If calls with this parameter enabled succeed, they return with the status code 204 No Content. If the underlying protocol does not support non-confirmable requests, or if the endpoint is registered in queue mode, the response is status code 409 Conflict. 
     */
    public v2EndpointsEndpointNameResourcePathPost (endpointName: string, resourcePath: string, resourceFunction?: string, noResp?: boolean) : Promise<{ response: http.IncomingMessage; body: AsyncID;  }> {
        const localVarPath = this.basePath + '/v2/endpoints/{endpointName}/{resourcePath}'
            .replace('{' + 'endpointName' + '}', String(endpointName))
            .replace('{' + 'resourcePath' + '}', String(resourcePath));
        let queryParameters: any = {};
     ...
     * @param noResp **Non-confirmable requests**  All resource APIs have the parameter noResp. If you make a request with noResp&#x3D;true, mbed Cloud Connect makes a CoAP non-confirmable request to the device. Such requests are not guaranteed to arrive in the device, and you do not get back an async-response-id.  If calls with this parameter enabled succeed, they return with the status code 204 No Content. If the underlying protocol does not support non-confirmable requests, or if the endpoint is registered in queue mode, the response is status code 409 Conflict. 
     */
    public v2EndpointsEndpointNameResourcePathPut (endpointName: string, resourcePath: string, resourceValue: string, noResp?: boolean) : Promise<{ response: http.IncomingMessage; body: AsyncID;  }> {
        const localVarPath = this.basePath + '/v2/endpoints/{endpointName}/{resourcePath}'
            .replace('{' + 'endpointName' + '}', String(endpointName))
            .replace('{' + 'resourcePath' + '}', String(resourcePath));
        let queryParameters: any = {};
...
export class SubscriptionsApi {
     ...
     */
    public v2SubscriptionsDelete () : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     * @param endpointName A unique identifier for the endpoint. Note that the endpoint name must be an exact match. You cannot use wildcards here. 
     */
    public v2SubscriptionsEndpointNameDelete (endpointName: string) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     */
    public v2SubscriptionsEndpointNameGet (endpointName: string) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/v2/subscriptions/{endpointName}'
            .replace('{' + 'endpointName' + '}', String(endpointName));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
     ...
     * @param resourcePath Resource&#39;s url. 
     */
    public v2SubscriptionsEndpointNameResourcePathDelete (endpointName: string, resourcePath: string) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
     ...
     * @param resourcePath Resource&#39;s url. 
     */
    public v2SubscriptionsEndpointNameResourcePathGet (endpointName: string, resourcePath: string) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/v2/subscriptions/{endpointName}/{resourcePath}'
            .replace('{' + 'endpointName' + '}', String(endpointName))
            .replace('{' + 'resourcePath' + '}', String(resourcePath));
        let queryParameters: any = {};
     ...
     * @param resourcePath Resource&#39;s URL. 
     */
    public v2SubscriptionsEndpointNameResourcePathPut (endpointName: string, resourcePath: string) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/v2/subscriptions/{endpointName}/{resourcePath}'
            .replace('{' + 'endpointName' + '}', String(endpointName))
            .replace('{' + 'resourcePath' + '}', String(resourcePath));
        let queryParameters: any = {};
     ...
     */
    public v2SubscriptionsGet () : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/v2/subscriptions';
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
        let formParams: any = {};
     ...
     */
    public v2SubscriptionsPut (presubsription: PresubscriptionArray) : Promise<{ response: http.IncomingMessage; body?: any;  }> {
        const localVarPath = this.basePath + '/v2/subscriptions';
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
        let formParams: any = {};
