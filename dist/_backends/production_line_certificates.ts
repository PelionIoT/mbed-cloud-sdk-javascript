...
export class DefaultApi {
     ...
     */
    public v3ProductionLineCertificatesGet (authorization: string) : Promise<{ response: http.IncomingMessage; body: AListOfProductionLineCertificates_;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: AListOfProductionLineCertificates_;  }>((resolve, reject) => {
     ...
     */
    public v3ProductionLineCertificatesMUUIDDelete (authorization: string, mUUID: string) : Promise<{ response: http.IncomingMessage; body: ProductionLineCertificate;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: ProductionLineCertificate;  }>((resolve, reject) => {
            request(requestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     * @param mUUID Certificate mUUID.
     */
    public v3ProductionLineCertificatesMUUIDGet (authorization: string, mUUID: string) : Promise<{ response: http.IncomingMessage; body: ProductionLineCertificate;  }> {
        const localVarPath = this.basePath + '/v3/production-line-certificates/{mUUID}'
            .replace('{' + 'mUUID' + '}', String(mUUID));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
     ...
     * @param body 
     */
    public v3ProductionLineCertificatesMUUIDPut (authorization: string, mUUID: string, body: Body1) : Promise<{ response: http.IncomingMessage; body: ProductionLineCertificate;  }> {
        const localVarPath = this.basePath + '/v3/production-line-certificates/{mUUID}'
            .replace('{' + 'mUUID' + '}', String(mUUID));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
     ...
     * @param body 
     */
    public v3ProductionLineCertificatesPost (authorization: string, body: Body) : Promise<{ response: http.IncomingMessage; body: ProductionLineCertificate;  }> {
        const localVarPath = this.basePath + '/v3/production-line-certificates';
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
        let formParams: any = {};
