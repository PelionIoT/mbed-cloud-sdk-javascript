...
export class DefaultApi {
     ...
     */
    public deviceQueryCreate (name: string, query: string, description?: string, object?: string, queryId?: string) : Promise<{ response: http.IncomingMessage; body: DeviceQueryDetail;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: DeviceQueryDetail;  }>((resolve, reject) => {
     ...
     * @param queryId 
     */
    public deviceQueryDestroy (queryId: string) : Promise<{ response: http.IncomingMessage; body: DeviceQueryDetail;  }> {
     ...
     * @param after 
     */
    public deviceQueryList (limit?: number, order?: string, after?: string) : Promise<{ response: http.IncomingMessage; body: DeviceQueryResp;  }> {
        const localVarPath = this.basePath + '/v3/device-queries/';
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
        let formParams: any = {};
        ...
        return new Promise<{ response: http.IncomingMessage; body: DeviceQueryResp;  }>((resolve, reject) => {
            request(requestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
     ...
     */
    public deviceQueryPartialUpdate (queryId: string, description?: string, name?: string, object?: string, query?: string, queryId2?: string) : Promise<{ response: http.IncomingMessage; body: DeviceQueryDetail;  }> {
        const localVarPath = this.basePath + '/v3/device-queries/{query_id}/'
            .replace('{' + 'query_id' + '}', String(queryId));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
     ...
     * @param queryId 
     */
    public deviceQueryRetrieve (queryId: string) : Promise<{ response: http.IncomingMessage; body: DeviceQueryDetail;  }> {
        const localVarPath = this.basePath + '/v3/device-queries/{query_id}/'
            .replace('{' + 'query_id' + '}', String(queryId));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
     ...
     * @param queryId2 DEPRECATED: The ID of the query
     */
    public deviceQueryUpdate (queryId: string, name: string, query: string, description?: string, object?: string, queryId2?: string) : Promise<{ response: http.IncomingMessage; body: DeviceQueryDetail;  }> {
        const localVarPath = this.basePath + '/v3/device-queries/{query_id}/'
            .replace('{' + 'query_id' + '}', String(queryId));
        let queryParameters: any = {};
        let headerParams: any = this.extendObj({}, this.defaultHeaders);
