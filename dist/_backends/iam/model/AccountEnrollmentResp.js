...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.IamIdentitiesRestApi.AccountEnrollmentResp = factory(root.IamIdentitiesRestApi.ApiClient);
  }
  ...
  /**
   * The AccountEnrollmentResp model module.
   * @module model/AccountEnrollmentResp
   * @version v3
   */

  /**
   * Constructs a new <code>AccountEnrollmentResp</code>.
   * This object represents an account creation response.
   * @alias module:model/AccountEnrollmentResp
   * @class
   * @param status {module:model/AccountEnrollmentResp.StatusEnum} The status of the user. INVITED means that the user has not accepted the invitation request. RESET means that the password must be changed immediately.
   ...
   * @param _object {module:model/AccountEnrollmentResp.ObjectEnum} Entity name: always 'user'
   * @param email {String} The email address.
   * @param etag {String} API resource entity version.
   * @param id {String} The UUID of the user.
   */
  var exports = function(status, username, accountId, aliases, _object, email, etag, id) {
    var _this = this;
  ...
  /**
   * Constructs a <code>AccountEnrollmentResp</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AccountEnrollmentResp} obj Optional instance to populate.
   * @return {module:model/AccountEnrollmentResp} The populated <code>AccountEnrollmentResp</code> instance.
   */
   ...
   * @member {module:model/AccountEnrollmentResp.StatusEnum} status
   */
   ...
   * @member {module:model/AccountEnrollmentResp.ObjectEnum} object
   */
