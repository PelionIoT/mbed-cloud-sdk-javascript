...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/UserInfoResp'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./UserInfoResp'));
  } else {
    // Browser globals (root is window)
    if (!root.IamIdentitiesRestApi) {
      root.IamIdentitiesRestApi = {};
    }
    root.IamIdentitiesRestApi.UserInfoRespList = factory(root.IamIdentitiesRestApi.ApiClient, root.IamIdentitiesRestApi.UserInfoResp);
  }
}(this, function(ApiClient, UserInfoResp) {
  'use strict';
  ...
  /**
   * The UserInfoRespList model module.
   * @module model/UserInfoRespList
   * @version v3
   */
   ...
   * @param data {Array.<module:model/UserInfoResp>} List of entities.
   */
  ...
  /**
   * Constructs a <code>UserInfoRespList</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UserInfoRespList} obj Optional instance to populate.
   * @return {module:model/UserInfoRespList} The populated <code>UserInfoRespList</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = ApiClient.convertToType(data['data'], [UserInfoResp]);
      }
  ...
  /**
   * List of entities.
   * @member {Array.<module:model/UserInfoResp>} data
   */
  exports.prototype['data'] = undefined;
  /**
   * The order of the records to return. Available values: ASC, DESC. Default value is ASC
   * @member {module:model/UserInfoRespList.OrderEnum} order
   */
