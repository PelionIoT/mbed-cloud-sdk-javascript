...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProvisioningEndpointsDeveloperCertificates.DeveloperCertificate = factory(root.ProvisioningEndpointsDeveloperCertificates.ApiClient);
  }
  ...
  /**
   * The DeveloperCertificate model module.
   * @module model/DeveloperCertificate
   * @version 0.8
   */

  /**
   * Constructs a new <code>DeveloperCertificate</code>.
   * @alias module:model/DeveloperCertificate
   * @class
   */
  ...
  /**
   * Constructs a <code>DeveloperCertificate</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeveloperCertificate} obj Optional instance to populate.
   * @return {module:model/DeveloperCertificate} The populated <code>DeveloperCertificate</code> instance.
   */
