...
export class ParameterBucketContainer extends Container {
    ...
    public async render(): Promise<string> {
        return await ejs.renderFile<string>("generator/containers/parameterBucketContainer/parameterBucket.ejs", { name: this.name, parameters: await this.getParameters() });
    }
