...
var Resource = (function (_super) {
    ...
    function Resource(_api, _deviceId, options) {
            ...
            if (eventName === Resource.EVENT_NOTIFICATION) {
                _this.createSubscription(function (error, asyncID) {
                    if (index_1.Devices.polling) {
                        ...
                        index_1.Devices.resourceSubs[_this._deviceId + _this.path] = _this;
                    }
                    else {
        ...
        _this.on("removeListener", function (eventName, listener) {
            if (eventName === Resource.EVENT_NOTIFICATION) {
                if (_this.listenerCount(Resource.EVENT_NOTIFICATION) === 0) {
                    // no-one is listening :(
                    delete index_1.Devices.resourceSubs[_this._deviceId + _this.path];
    ...
    */
    Resource.prototype.getValue = function (options, callback) {
        ...
        return pg(function (done) {
            _this._api.resources.v2EndpointsEndpointNameResourcePathGet(_this._deviceId, _this.path, cacheOnly, noResp, function (error, data) {
                if (error)
                    return done(error);
    ...
    */
    Resource.prototype.getSubscription = function (callback) {
        ...
        return pg(function (done) {
            ...
            _this._api.subscriptions.v2SubscriptionsEndpointNameResourcePathGet(_this._deviceId, _this.path, function (error, data) {
                if (error)
                    return done(error);
                done(null, data);
            });
    ...
    */
    Resource.prototype.createSubscription = function (callback) {
        var _this = this;
        return pg(function (done) {
            _this._api.subscriptions.v2SubscriptionsEndpointNameResourcePathPut(_this._deviceId, _this.path, function (error, data) {
                if (error)
                    return done(error);
                var asyncID = data["async-response-id"];
                if (asyncID) {
    ...
    */
    Resource.prototype.deleteSubscription = function (callback) {
        var _this = this;
        return pg(function (done) {
            _this._api.subscriptions.v2SubscriptionsEndpointNameResourcePathDelete(_this._deviceId, _this.path, done);
        }, callback);
    };
    return Resource;
