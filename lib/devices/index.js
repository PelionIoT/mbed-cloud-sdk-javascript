...
var Devices = (function (_super) {
    ...
    */
    ...
    Devices.prototype.mapDevice = function (from) {
        var type = {
        ...
        return new device_1.Device(this._api, type);
    };
    Devices.prototype.mapQuery = function (from) {
        var type = {
            createdAt: from.created_at,
            description: from.description,
            id: from.id,
        ...
        return new query_1.Query(this._api, type);
    };
    /**
    * Create a device
    ...
    */
    Devices.prototype.listDevices = function (options, callback) {
        var _this = this;
        options = options || {};
        if (typeof options === "function") {
            callback = options;
        ...
        return pg(function (done) {
            _this._api.catalog.deviceList(limit, order, after, filter, include, function (error, data) {
                if (error)
                    return done(error);
                var devices = data.data.map(_this.mapDevice);
    ...
    */
    Devices.prototype.getWebhook = function (callback) {
    ...
    * @returns Optional Promise containing any error
    */
    Devices.prototype.updateWebhook = function (options, callback) {
    ...
    * @returns Optional Promise containing any error
    */
    Devices.prototype.deleteWebhook = function (callback) {
    ...
    */
    Devices.prototype.listQueries = function (options, callback) {
        ...
        return pg(function (done) {
            _this._api.query.deviceQueryList(limit, order, after, include, function (error, data) {
                if (error)
                    return done(error);
                var queries = data.data.map(_this.mapQuery);
    ...
    */
    Devices.prototype.updateQuery = function (options, callback) {
        ...
        if (name && query) {
            // Full update
            return pg(function (done) {
                _this._api.query.deviceQueryUpdate(id, options, function (error, data) {
                    if (error)
                        return done(error);
                    var query = _this.mapQuery(data);
                    done(null, query);
