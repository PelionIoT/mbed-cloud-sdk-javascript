...
var AccountManagementApi = /** @class */ (function () {
    ...
    AccountManagementApi.prototype.listUsers = function (options, callback) {
        ...
        return functions_1.apiWrapper(function (resultsFn) {
            var _a = options, limit = _a.limit, after = _a.after, order = _a.order, include = _a.include, filter = _a.filter;
            _this._endpoints.admin.getAllUsers(limit, after, order, functions_1.encodeInclude(include), functions_1.extractFilter(filter, "email"), functions_1.extractFilter(filter, "status"), resultsFn);
        }, function (data, done) {
            var users;
