...
var DeviceGroupRepository = /** @class */ (function (_super) {
    ...
    DeviceGroupRepository.prototype.create = function (request) {
        ...
        return functions_1.apiWrapper(function (resultsFn) {
            ...
            done(null, index_3.DeviceGroupAdapter.fromApi(data, request));
        });
    };
    /**
     * delete
    ...
    DeviceGroupRepository.prototype.devices = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_2.DeviceAdapter.fromApi, pageOptions));
            }, null);
        };
    ...
    DeviceGroupRepository.prototype.list = function (options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_3.DeviceGroupAdapter.fromApi, pageOptions));
            }, null);
        };
        return new index_1.Paginator(pageFunc, options);
    };
    ...
    DeviceGroupRepository.prototype.read = function (id) {
        ...
        return functions_1.apiWrapper(function (resultsFn) {
            ...
            done(null, index_3.DeviceGroupAdapter.fromApi(data));
        });
    };
    /**
     * removeDevice
