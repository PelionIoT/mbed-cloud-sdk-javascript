    ...
    DeviceGroupRepository.prototype.devices = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_3.Page(data, data.data, index_2.DeviceAdapter.fromApi, pageOptions));
            }, null);
        };
    ...
    DeviceGroupRepository.prototype.list = function (options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_3.Page(data, data.data, index_1.DeviceGroupAdapter.fromApi, pageOptions));
            }, null);
        };
        return new index_3.Paginator(pageFunc, options);
    };
