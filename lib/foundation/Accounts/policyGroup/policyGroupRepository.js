...
var PolicyGroupRepository = /** @class */ (function (_super) {
    ...
    PolicyGroupRepository.prototype.create = function (request) {
        ...
        return functions_1.apiWrapper(function (resultsFn) {
            ...
            done(null, index_3.PolicyGroupAdapter.fromApi(data, request));
        });
    };
    /**
     * delete
    ...
    PolicyGroupRepository.prototype.read = function (id) {
        ...
        return functions_1.apiWrapper(function (resultsFn) {
            ...
            done(null, index_3.PolicyGroupAdapter.fromApi(data));
        });
    };
    /**
     * update
    ...
    PolicyGroupRepository.prototype.users = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_4.UserAdapter.fromApi, pageOptions));
            }, null);
        };
        return new index_1.Paginator(pageFunc, options);
    };
