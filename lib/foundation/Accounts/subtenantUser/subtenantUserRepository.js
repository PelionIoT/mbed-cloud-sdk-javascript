...
var SubtenantUserRepository = /** @class */ (function (_super) {
    ...
    SubtenantUserRepository.prototype.create = function (request, accountId, action) {
        ...
        return functions_1.apiWrapper(function (resultsFn) {
            ...
            done(null, index_2.SubtenantUserAdapter.fromApi(data, request));
        });
    };
    /**
     * delete
     ...
     */
    SubtenantUserRepository.prototype.policyGroups = function (accountId, id, options) {
        var _this = this;
    ...
    SubtenantUserRepository.prototype.read = function (accountId, id) {
        ...
        return functions_1.apiWrapper(function (resultsFn) {
            ...
            done(null, index_2.SubtenantUserAdapter.fromApi(data));
        });
    };
    /**
     * update
