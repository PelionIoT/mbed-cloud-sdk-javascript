...
var UserRepository = /** @class */ (function (_super) {
    ...
    UserRepository.prototype.create = function (request, action) {
        ...
        return functions_1.apiWrapper(function (resultsFn) {
            ...
            done(null, index_2.UserAdapter.fromApi(data, request));
        });
    };
    /**
     * delete
    ...
    UserRepository.prototype.list = function (options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_2.UserAdapter.fromApi, pageOptions));
            }, null);
        };
     ...
     */
    UserRepository.prototype.policyGroups = function (id, options) {
        var _this = this;
        var pageFunc = function (pageOptions) {
            pageOptions = pageOptions || {};
            return functions_1.apiWrapper(function (resultsFn) {
    ...
    UserRepository.prototype.read = function (id) {
        ...
        return functions_1.apiWrapper(function (resultsFn) {
            ...
            done(null, index_2.UserAdapter.fromApi(data));
        });
    };
    /**
     * update
