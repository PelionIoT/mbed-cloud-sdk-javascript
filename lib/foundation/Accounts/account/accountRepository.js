    ...
    AccountRepository.prototype.apiKeys = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_8.SubtenantApiKeyAdapter.fromApi, pageOptions));
            }, null);
        };
...
*/
    AccountRepository.prototype.create = function (request, action) {
        ...
        return functions_1.apiWrapper(function (resultsFn) {
            ...
            done(null, index_4.AccountAdapter.fromApi(data, request));
        });
    };
    /**
    ...
    AccountRepository.prototype.darkThemeBrandingColors = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_5.SubtenantDarkThemeColorAdapter.fromApi, pageOptions));
            }, null);
        };
        return new index_1.Paginator(pageFunc, options);
    };
    ...
    AccountRepository.prototype.darkThemeBrandingImages = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_6.SubtenantDarkThemeImageAdapter.fromApi, pageOptions));
            }, null);
        };
        return new index_1.Paginator(pageFunc, options);
    };
    ...
    AccountRepository.prototype.lightThemeBrandingColors = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_7.SubtenantLightThemeColorAdapter.fromApi, pageOptions));
            }, null);
        };
        return new index_1.Paginator(pageFunc, options);
    };
    ...
    AccountRepository.prototype.lightThemeBrandingImages = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_2.SubtenantLightThemeImageAdapter.fromApi, pageOptions));
            }, null);
        };
        return new index_1.Paginator(pageFunc, options);
    };
    ...
    AccountRepository.prototype.list = function (options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_4.AccountAdapter.fromApi, pageOptions));
            }, null);
        };
        return new index_1.Paginator(pageFunc, options);
    };
    ...
    AccountRepository.prototype.me = function (options) {
        ...
        return functions_1.apiWrapper(function (resultsFn) {
            ...
            done(null, index_4.AccountAdapter.fromApi(data));
        });
    };
    /**
     * read
    ...
    AccountRepository.prototype.trustedCertificates = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_10.SubtenantTrustedCertificateAdapter.fromApi, pageOptions));
            }, null);
        };
        return new index_1.Paginator(pageFunc, options);
    };
    ...
    AccountRepository.prototype.userInvitations = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_9.SubtenantUserInvitationAdapter.fromApi, pageOptions));
            }, null);
        };
        return new index_1.Paginator(pageFunc, options);
    };
    ...
    AccountRepository.prototype.users = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_3.SubtenantUserAdapter.fromApi, pageOptions));
            }, null);
        };
        return new index_1.Paginator(pageFunc, options);
    };
