...
var Factory = /** @class */ (function () {
    ...
    Factory.prototype.identityProviderRepository = function () {
        return new _21.IdentityProviderRepository(this._config);
    };
    Factory.prototype.lightThemeColorRepository = function () {
        return new _22.LightThemeColorRepository(this._config);
    };
    Factory.prototype.lightThemeImageRepository = function () {
        return new _23.LightThemeImageRepository(this._config);
    };
    Factory.prototype.policyGroupRepository = function () {
        return new _24.PolicyGroupRepository(this._config);
    };
    Factory.prototype.preSharedKeyRepository = function () {
        return new _25.PreSharedKeyRepository(this._config);
    };
    Factory.prototype.serverCredentialsRepository = function () {
        return new _26.ServerCredentialsRepository(this._config);
    };
    Factory.prototype.subtenantApiKeyRepository = function () {
        return new _27.SubtenantApiKeyRepository(this._config);
    };
    Factory.prototype.subtenantDarkThemeColorRepository = function () {
        return new _28.SubtenantDarkThemeColorRepository(this._config);
    };
    Factory.prototype.subtenantDarkThemeImageRepository = function () {
        return new _29.SubtenantDarkThemeImageRepository(this._config);
    };
    Factory.prototype.subtenantIdentityProviderRepository = function () {
        return new _30.SubtenantIdentityProviderRepository(this._config);
    };
    Factory.prototype.subtenantLightThemeColorRepository = function () {
        return new _31.SubtenantLightThemeColorRepository(this._config);
    };
    Factory.prototype.subtenantLightThemeImageRepository = function () {
        return new _32.SubtenantLightThemeImageRepository(this._config);
    };
    Factory.prototype.subtenantPolicyGroupRepository = function () {
        return new _33.SubtenantPolicyGroupRepository(this._config);
    };
    Factory.prototype.subtenantTrustedCertificateRepository = function () {
        return new _34.SubtenantTrustedCertificateRepository(this._config);
    };
    Factory.prototype.subtenantUserRepository = function () {
        return new _35.SubtenantUserRepository(this._config);
    };
    Factory.prototype.subtenantUserInvitationRepository = function () {
        return new _36.SubtenantUserInvitationRepository(this._config);
    };
    Factory.prototype.trustedCertificateRepository = function () {
        return new _37.TrustedCertificateRepository(this._config);
    };
    Factory.prototype.updateCampaignRepository = function () {
        return new _38.UpdateCampaignRepository(this._config);
    };
    Factory.prototype.userRepository = function () {
        return new _39.UserRepository(this._config);
    };
    Factory.prototype.userInvitationRepository = function () {
        return new _40.UserInvitationRepository(this._config);
    };
    return Factory;
}());
