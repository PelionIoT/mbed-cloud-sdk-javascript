...
var UpdateCampaignRepository = /** @class */ (function (_super) {
    ...
    UpdateCampaignRepository.prototype.archive = function (id) {
        ...
        return functions_1.apiWrapper(function (resultsFn) {
            ...
            done(null, index_2.UpdateCampaignAdapter.fromApi(data));
        });
    };
    /**
     * create
    ...
    UpdateCampaignRepository.prototype.create = function (request) {
        ...
        return functions_1.apiWrapper(function (resultsFn) {
            ...
            done(null, index_2.UpdateCampaignAdapter.fromApi(data, request));
        });
    };
    /**
     * delete
    ...
    UpdateCampaignRepository.prototype.deviceMetadata = function (id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_3.CampaignDeviceMetadataAdapter.fromApi, pageOptions));
            }, null);
        };
    ...
    UpdateCampaignRepository.prototype.list = function (options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_2.UpdateCampaignAdapter.fromApi, pageOptions));
            }, null);
        };
        return new index_1.Paginator(pageFunc, options);
    };
