...
var CampaignStatisticsRepository = /** @class */ (function (_super) {
    ...
    CampaignStatisticsRepository.prototype.events = function (campaignId, id, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_2.CampaignStatisticsEventsAdapter.fromApi, pageOptions));
            }, null);
        };
    ...
    CampaignStatisticsRepository.prototype.list = function (campaignId, options) {
        ...
        var pageFunc = function (pageOptions) {
            ...
            return functions_1.apiWrapper(function (resultsFn) {
                ...
                done(null, new index_1.Page(data, data.data, index_3.CampaignStatisticsAdapter.fromApi, pageOptions));
            }, null);
        };
        return new index_1.Paginator(pageFunc, options);
    };
    ...
    CampaignStatisticsRepository.prototype.read = function (campaignId, id) {
        ...
        return functions_1.apiWrapper(function (resultsFn) {
            ...
            done(null, index_3.CampaignStatisticsAdapter.fromApi(data));
        });
    };
