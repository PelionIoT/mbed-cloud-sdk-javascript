...
var masterObserver_1 = require("./observers/masterObserver");
var Subscribe = /** @class */ (function () {
    function Subscribe(_connect) {
        ...
        this.masterObserver = new masterObserver_1.MasterObserver();
    }
    /**
     ...
     */
    Subscribe.prototype.allNotifications = function () {
        this.startNotifications();
     ...
     * @param data
     */
    Subscribe.prototype.notifyAllNotifications = function (data) {
