...
var Api = /** @class */ (function (_super) {
    ...
    Api.prototype.complete = function (error, response, json, callback) {
        return _super.prototype.complete.call(this, error, response, json, callback);
    };
    return Api;
}(apiBase_1.ApiBase));
suite("apiBase", function () {
    ...
    test("should execute callback", function () {
        api.complete(null, null, false, function (_error, _data) {
            assert(true);
        });
    });
    ...
    test("should not make date with json", function () {
    ...
    test("should not make date without json", function () {
        var date = "nineteen-seventy-seven";
        api.complete(null, {
            body: {
                birthday: date
