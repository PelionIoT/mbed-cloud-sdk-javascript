...
suite("testSubscribe", function () {
    test("allEvents", function () {
        ...
        var items = [];
        var observer = subscribe.deviceStateChanges();
    ...
    test("oneDeviceId", function () {
        var subscribe = new subscribe_1.Subscribe();
        var items = [];
        var observer = subscribe.deviceStateChanges({ id: "1" });
        observer.addListener(function (res) { return items.push(res); });
        mockNotify(subscribe);
    ...
    test("multipleDeviceId", function () {
        var subscribe = new subscribe_1.Subscribe();
        var items = [];
        var observer = subscribe.deviceStateChanges({ id: ["1", "2"] });
        observer.addListener(function (res) { return items.push(res); });
        mockNotify(subscribe);
        assert.lengthOf(items, 16);
        mockNotify(subscribe);
    ...
    test("oneState", function () {
        var subscribe = new subscribe_1.Subscribe();
        var items = [];
        var observer = subscribe.deviceStateChanges({ event: "registration" });
        observer.addListener(function (res) { return items.push(res); });
        mockNotify(subscribe);
    ...
    test("multipleStates", function () {
        var subscribe = new subscribe_1.Subscribe();
        var items = [];
        var observer = subscribe.deviceStateChanges({ event: ["registration", "deregistration"] });
        observer.addListener(function (res) { return items.push(res); });
        mockNotify(subscribe);
        assert.lengthOf(items, 18);
        mockNotify(subscribe);
    ...
    test("specific", function () {
        var subscribe = new subscribe_1.Subscribe();
        var items = [];
        var observer = subscribe.deviceStateChanges({ id: "1", event: "registration" });
        observer.addListener(function (res) { return items.push(res); });
        mockNotify(subscribe);
    ...
    test("multipleSpecific", function () {
        var subscribe = new subscribe_1.Subscribe();
        var items = [];
        var observer = subscribe.deviceStateChanges({ id: ["1", "3"], event: ["registration", "deregistration"] });
        observer.addListener(function (res) { return items.push(res); });
        mockNotify(subscribe);
        assert.lengthOf(items, 8);
        mockNotify(subscribe);
...
function mockNotify(subscribe) {
    ...
    regList.forEach(function (item) { return subscribe.notifyDeviceEvents(item); });
}
