...
var AccountAdminApi = /** @class */ (function (_super) {
     ...
     */
    AccountAdminApi.prototype.getAllUsers = function (limit, after, order, include, statusEq, callback, requestOptions) {
        var headerParams = {};
        var queryParameters = {};
        if (limit !== undefined) {
     ...
     */
    AccountAdminApi.prototype.getUser = function (userId, callback, requestOptions) {
        // verify required parameter "userId" is set
        if (userId === null || userId === undefined) {
            if (callback) {
                callback(new sdkError_1.SDKError("Required parameter 'userId' missing."));
...
var DeveloperApi = /** @class */ (function (_super) {
     ...
     */
    DeveloperApi.prototype.getAllApiKeys = function (limit, after, order, include, ownerEq, callback, requestOptions) {
        var headerParams = {};
        var queryParameters = {};
        if (limit !== undefined) {
            queryParameters["limit"] = limit;
     ...
     */
    DeveloperApi.prototype.getAllCertificates = function (limit, after, order, include, serviceEq, expireEq, deviceExecutionModeEq, ownerEq, callback, requestOptions) {
        var headerParams = {};
        var queryParameters = {};
        if (limit !== undefined) {
            queryParameters["limit"] = limit;
     ...
     * @param include Comma separated additional data to return. Currently supported: total_count
     */
    DeveloperApi.prototype.getAllGroups = function (limit, after, order, include, callback, requestOptions) {
        var headerParams = {};
        var queryParameters = {};
        if (limit !== undefined) {
            queryParameters["limit"] = limit;
     ...
     */
    DeveloperApi.prototype.getMyAccountInfo = function (include, callback, requestOptions) {
        var headerParams = {};
        var queryParameters = {};
        if (include !== undefined) {
            queryParameters["include"] = include;
     ...
     */
    DeveloperApi.prototype.getMyUser = function (scratchCodes, callback, requestOptions) {
        var headerParams = {};
        var queryParameters = {};
