...
var ConnectedDevice = /** @class */ (function (_super) {
    ...
    ConnectedDevice.prototype.getResourceValue = function (resourcePath, cacheOnly, noResponse, callback) {
        var _this = this;
        ...
        return functions_1.asyncStyle(function (done) {
            _this._connectApi.getResourceValue(_this.id, resourcePath, cacheOnly, noResponse, done);
        }, callback);
    };
    ConnectedDevice.prototype.setResourceValue = function (resourcePath, value, noResponse, callback) {
        var _this = this;
        noResponse = noResponse || false;
        if (typeof noResponse === "function") {
            callback = noResponse;
        ...
        return functions_1.asyncStyle(function (done) {
            _this._connectApi.setResourceValue(_this.id, resourcePath, value, noResponse, done);
        }, callback);
    };
    ConnectedDevice.prototype.executeResource = function (resourcePath, functionName, noResponse, callback) {
        var _this = this;
        noResponse = noResponse || false;
        if (typeof noResponse === "function") {
            callback = noResponse;
        ...
        return functions_1.asyncStyle(function (done) {
            _this._connectApi.executeResource(_this.id, resourcePath, functionName, noResponse, done);
        }, callback);
    };
    ...
    ConnectedDevice.prototype.deleteResource = function (resourcePath, noResponse, callback) {
        var _this = this;
        noResponse = noResponse || false;
        if (typeof noResponse === "function") {
            callback = noResponse;
        ...
        return functions_1.asyncStyle(function (done) {
            _this._connectApi.deleteResource(_this.id, resourcePath, noResponse, done);
        }, callback);
    };
