...
var ConnectApi = /** @class */ (function (_super) {
    ...
    ConnectApi.prototype.getResource = function (deviceId, path, callback) {
        var _this = this;
        ...
        return functions_1.apiWrapper(function (resultsFn) {
            ...
            var found = data.find(function (resource) {
                return _this.normalizePath(resource.uri) === path;
            });
            if (!found) {
    ...
    ConnectApi.prototype.setResourceValue = function (deviceId, path, value, noResponse, callback) {
        ...
        return functions_1.apiWrapper(function (resultsFn) {
            _this._endpoints.resources.v2EndpointsDeviceIdResourcePathPut(deviceId, path, value, noResponse, resultsFn);
        }, function (data, done) {
            var asyncID = data[_this.ASYNC_KEY];
            if (_this.handleNotifications && asyncID) {
                _this._asyncFns[asyncID] = done;
    ...
    ConnectApi.prototype.addResourceSubscription = function (deviceId, path, notifyFn, callback) {
        var _this = this;
        path = this.normalizePath(path);
        return functions_1.apiWrapper(function (resultsFn) {
