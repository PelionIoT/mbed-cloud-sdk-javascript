...
var tlv_1 = require("../../common/tlv");
var resourceValue_1 = require("../connect/models/resourceValue");
 ...
 * @ignore
 */
function parseResourceValue(_a) {
    var payload = _a.payload, resource = _a.resource, tlvParser = _a.tlvParser;
    return new resourceValue_1.ResourceValue({ payload: payload, resource: resource, tlvParser: tlvParser });
}
exports.parseResourceValue = parseResourceValue;
function parseValueFromType(value, type) {
    if (type === tlv_1.TlvDataType.Float) {
        return parseFloat(value) ? parseFloat(value) : value;
    }
    if (type === tlv_1.TlvDataType.Integer) {
        return parseInt(value, 10) ? parseInt(value, 10) : value;
    }
    if (type === tlv_1.TlvDataType.Boolean) {
        return value === "1" ? "True" : value === "0" ? "False" : value;
    }
    if (type === tlv_1.TlvDataType.Time) {
        return new Date(+value * 1000).toString();
    }
    return value;
}
exports.parseValueFromType = parseValueFromType;
/**
 * Internal function
 * @ignore
 */
