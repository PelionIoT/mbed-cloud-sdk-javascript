...
var ApiBase = /** @class */ (function () {
    ...
    ApiBase.isFileParam = function (param) {
        ...
        if (functions_1.isThisNode() && require("fs") && param instanceof require("fs").ReadStream) {
            return true;
        }
        // Buffer in Node.js
    ...
    ApiBase.prototype.request = function (options, callback) {
        ...
        requestOptions.url =
            requestOptions.url ||
                options.url.replace(/([:])?\/+/g, function ($0, $1) {
                    return $1 ? $0 : "/";
                });
    ...
    ApiBase.prototype.complete = function (error, response, acceptHeader, callback) {
        ...
        if (error) {
            ...
            sdkError = new sdkError_1.SDKError(message, null, null, innerError, details, error.status);
        }
