...
export class AccountAdapter extends Adapter {
    ...
    static fromApi(data, instance) {
        ...
        const mappedEntity = AccountAdapter.assignDefined(instance || {}, {
            ...
            expirationWarningThreshold: data.expiration_warning_threshold || undefined,
            id: data.id,
            idleTimeout: data.idle_timeout || undefined,
            ...
            passwordRecoveryExpiration: data.password_recovery_expiration || undefined,
