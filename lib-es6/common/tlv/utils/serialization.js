 ...
 */
export function bytesToFloat(bytes) {
    if (bytes.length === 4) {
 ...
 */
export function uint8ToBytes(value) {
    return [value & 0xff];
}
/**
 ...
 */
export function uint24ToBytes(value) {
 ...
 * be added).
 */
export function bytesToHexDump(bytes, includeAsciiRepresentation = false, maximumNumberOfBytes) {
