...
export class DefaultApi extends ApiBase {
     ...
     */
    firmwareImageCreate(datafile, name, description, callback, requestOptions) {
     ...
     */
    firmwareImageDestroy(imageId, callback, requestOptions) {
     ...
     */
    firmwareImageList(limit, order, after, filter, include, callback, requestOptions) {
        const headerParams = {};
        const queryParameters = {};
        if (limit !== undefined) {
     ...
     * @param imageId The firmware image ID
     */
    firmwareImageRetrieve(imageId, callback, requestOptions) {
        // verify required parameter "imageId" is set
        if (imageId === null || imageId === undefined) {
            if (callback) {
                callback(new SDKError("Required parameter 'imageId' missing."));
     ...
     */
    firmwareManifestCreate(datafile, name, description, keyTable, callback, requestOptions) {
        // verify required parameter "datafile" is set
        if (datafile === null || datafile === undefined) {
            if (callback) {
                callback(new SDKError("Required parameter 'datafile' missing."));
     ...
     */
    firmwareManifestDestroy(manifestId, callback, requestOptions) {
     ...
     * @param include Comma-separated list of data fields to return. Currently supported: total_count
     */
    firmwareManifestList(limit, order, after, filter, include, callback, requestOptions) {
        const headerParams = {};
        const queryParameters = {};
        if (limit !== undefined) {
            queryParameters["limit"] = limit;
     ...
     * @param manifestId The firmware manifest ID
     */
    firmwareManifestRetrieve(manifestId, callback, requestOptions) {
        // verify required parameter "manifestId" is set
        if (manifestId === null || manifestId === undefined) {
            if (callback) {
                callback(new SDKError("Required parameter 'manifestId' missing."));
     ...
     */
    updateCampaignCreate(campaign, callback, requestOptions) {
     ...
     */
    updateCampaignDestroy(campaignId, callback, requestOptions) {
     ...
     * @param include Comma-separated list of data fields to return. Currently supported: total_count
     */
    updateCampaignList(limit, order, after, filter, include, callback, requestOptions) {
        const headerParams = {};
        const queryParameters = {};
        if (limit !== undefined) {
            queryParameters["limit"] = limit;
     ...
     * @param include Comma-separated list of data fields to return. Currently supported: total_count
     */
    updateCampaignMetadataList(campaignId, limit, order, after, include, callback, requestOptions) {
        // verify required parameter "campaignId" is set
        if (campaignId === null || campaignId === undefined) {
            if (callback) {
                callback(new SDKError("Required parameter 'campaignId' missing."));
     ...
     */
    updateCampaignMetadataRetrieve(campaignId, campaignDeviceMetadataId, callback, requestOptions) {
        // verify required parameter "campaignId" is set
        if (campaignId === null || campaignId === undefined) {
            if (callback) {
                callback(new SDKError("Required parameter 'campaignId' missing."));
     ...
     */
    updateCampaignMetadataStop(campaignId, callback, requestOptions) {
        // verify required parameter "campaignId" is set
        if (campaignId === null || campaignId === undefined) {
            if (callback) {
                callback(new SDKError("Required parameter 'campaignId' missing."));
     ...
     * @param campaignId The campaign ID
     */
    updateCampaignRetrieve(campaignId, callback, requestOptions) {
        // verify required parameter "campaignId" is set
        if (campaignId === null || campaignId === undefined) {
            if (callback) {
                callback(new SDKError("Required parameter 'campaignId' missing."));
     ...
     * @param campaign Update campaign
     */
    updateCampaignUpdate(campaignId, campaign, callback, requestOptions) {
        // verify required parameter "campaignId" is set
        if (campaignId === null || campaignId === undefined) {
            if (callback) {
                callback(new SDKError("Required parameter 'campaignId' missing."));
