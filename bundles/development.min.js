!function(t){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=t();else if("function"==typeof define&&define.amd)define([],t);else{var e;e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this,e.mbedCloudSDK=t()}}(function(){return function t(e,r,i){function n(s,a){if(!r[s]){if(!e[s]){var u="function"==typeof require&&require;if(!a&&u)return u(s,!0);if(o)return o(s,!0);var p=new Error("Cannot find module '"+s+"'");throw p.code="MODULE_NOT_FOUND",p}var h=r[s]={exports:{}};e[s][0].call(h.exports,function(t){var r=e[s][1][t];return n(r?r:t)},h,h.exports,t,e,r,i)}return r[s].exports}for(var o="function"==typeof require&&require,s=0;s<i.length;s++)n(i[s]);return n}({1:[function(t,e,r){(function(e){"use strict";function i(t,e){var r=t.uri;r=r.replace(/([:])?\/+/g,function(t,e){return e?t:"/"});var i=a(t.method,r);if(t.auth&&(t.auth.username||t.auth.password)&&i.auth(t.auth.username||"",t.auth.password||""),i.query(n(t.qs)),i.set(n(t.headers)),i.timeout(6e4),t.json&&(i.type("application/json"),i.accept("application/json")),t.form)i.type("application/x-www-form-urlencoded"),i.send(n(t.form));else if(t.formData){i.type("multipart/form-data");var s=n(t.formData);for(var u in s)s.hasOwnProperty(u)&&(o(s[u])?i.attach(u,s[u]):i.field(u,s[u]))}else t.body&&i.send(t.body);return i.end(function(t,r){if(e){var i=null;r&&!t&&(i=r.body||r.text),e(t,i,r)}}),i}function n(t){var e={};for(var r in t)if(t.hasOwnProperty(r)&&void 0!=t[r]&&null!=t[r]){var i=t[r];o(i)||Array.isArray(i)?e[r]=i:e[r]=s(i)}return e}function o(r){return!!("undefined"==typeof window&&"function"==typeof t&&t("fs")&&r instanceof t("fs").ReadStream)||("function"==typeof e&&r instanceof e||("function"==typeof Blob&&r instanceof Blob||"function"==typeof File&&r instanceof File))}function s(t){return void 0==t||null==t?"":t instanceof Date?t.toJSON():t.toString()}var a=t("superagent"),u="https://api.mbedcloud.com";r.request=i,r.normalizeParams=n,r.isFileParam=o,r.paramToString=s;var p=function(){function t(){}return t.prototype.applyToRequest=function(t){t.auth={username:this.username,password:this.password}},t}();r.HttpBasicAuth=p;var h=function(){function t(){}return t.prototype.applyToRequest=function(t){t&&t.headers&&(t.headers.Authorization="Bearer "+this.accessToken)},t}();r.OAuth=h;var c=function(){function t(t,e){this.location=t,this.paramName=e}return t.prototype.applyToRequest=function(t){"query"==this.location?t.qs[this.paramName]=this.apiKey:"header"==this.location&&t&&t.headers&&(t.headers[this.paramName]=this.apiKey)},t}();r.ApiKeyAuth=c;var f=function(){function t(){}return t.prototype.applyToRequest=function(t){},t}();r.VoidAuth=f,function(t){t[t.Bearer=0]="Bearer"}(r.DefaultApiApiKeys||(r.DefaultApiApiKeys={}));var l=r.DefaultApiApiKeys,d=function(){function t(t,e,r){this.basePath=u,this.defaultHeaders={},this._useQuerystring=!1,this.authentications={default:new f,Bearer:new c("header","Authorization")},e?r&&(this.basePath=r):t&&(this.basePath=t)}return Object.defineProperty(t.prototype,"useQuerystring",{set:function(t){this._useQuerystring=t},enumerable:!0,configurable:!0}),t.prototype.setApiKey=function(t,e){this.authentications[l[t]].apiKey=e},t.prototype.extendObj=function(t,e){for(var r in e)e.hasOwnProperty(r)&&(t[r]=e[r]);return t},t.prototype.v3DeveloperCertificateDelete=function(t,e){var r=this.basePath+"/v3/developer-certificate",n={},o=this.extendObj({},this.defaultHeaders),s={};if(null===t||void 0===t)return void(e&&e(new Error("Required parameter authorization was null or undefined when calling v3DeveloperCertificateDelete.")));o.Authorization=t;var a=!1,u={method:"DELETE",qs:n,headers:o,uri:r,useQuerystring:this._useQuerystring,json:!0};return this.authentications.Bearer.applyToRequest(u),this.authentications.default.applyToRequest(u),Object.keys(s).length&&(a?u.formData=s:u.form=s),i(u,function(t,r,i){e&&e(t,r,i)})},t.prototype.v3DeveloperCertificateGet=function(t,e){var r=this.basePath+"/v3/developer-certificate",n={},o=this.extendObj({},this.defaultHeaders),s={};if(null===t||void 0===t)return void(e&&e(new Error("Required parameter authorization was null or undefined when calling v3DeveloperCertificateGet.")));o.Authorization=t;var a=!1,u={method:"GET",qs:n,headers:o,uri:r,useQuerystring:this._useQuerystring,json:!0};return this.authentications.Bearer.applyToRequest(u),this.authentications.default.applyToRequest(u),Object.keys(s).length&&(a?u.formData=s:u.form=s),i(u,function(t,r,i){e&&e(t,r,i)})},t.prototype.v3DeveloperCertificatePost=function(t,e,r){var n=this.basePath+"/v3/developer-certificate",o={},s=this.extendObj({},this.defaultHeaders),a={};if(null===t||void 0===t)return void(r&&r(new Error("Required parameter authorization was null or undefined when calling v3DeveloperCertificatePost.")));if(null===e||void 0===e)return void(r&&r(new Error("Required parameter body was null or undefined when calling v3DeveloperCertificatePost.")));s.Authorization=t;var u=!1,p={method:"POST",qs:o,headers:s,uri:n,useQuerystring:this._useQuerystring,json:!0,body:e};return this.authentications.Bearer.applyToRequest(p),this.authentications.default.applyToRequest(p),Object.keys(a).length&&(u?p.formData=a:p.form=a),i(p,function(t,e,i){r&&r(t,e,i)})},t}();r.DefaultApi=d}).call(this,t("buffer").Buffer)},{buffer:5,fs:5,superagent:7}],2:[function(t,e,r){"use strict";/*
...
*/
var i=t("polygoat"),n=function(){function t(t,e){this._api=e;for(var r in t)this[r]=t[r]}return t.map=function(e,r){var i={createdAt:e.created_at,id:e.id,publicKey:e.pub_key};return new t(i,r)},t.reverseMap=function(t){return{pub_key:t.publicKey}},t.prototype.delete=function(t){var e=this;return i(function(t){e._api.deleteCertificate(t)},t)},t}();r.DeveloperCertificate=n},{polygoat:6}],3:[function(t,e,r){"use strict";var i=t("../_api/developer_certificate"),n=function(){function t(t){this.development=new i.DefaultApi(t.host),this.development.setApiKey(i.DefaultApiApiKeys.Bearer,"Bearer "+t.apiKey)}return t}();r.Endpoints=n},{"../_api/developer_certificate":1}],4:[function(t,e,r){"use strict";/*
* mbed Cloud JavaScript SDK
* Copyright ARM Limited 2017
*
* Licensed under the Apache License, Version 2.0 (the "License");
