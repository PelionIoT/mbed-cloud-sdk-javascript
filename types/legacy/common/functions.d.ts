 ...
 * @ignore
 */
export declare function parseResourceValue({ payload, resource, tlvParser, }: {
    payload: string;
    resource?: Resource;
    tlvParser?: TlvParser;
}): ResourceValue;
export declare function parseValueFromType(value: string, type: TlvDataType): string | number;
/**
 * Internal function
 * @ignore
 */
