...
export declare class ConnectApi extends EventEmitter {
    ...
    private readonly _websockerUrl;
    private _instanceId;
     ...
     */
    getWebsocket(callback: CallbackFn<Websocket>): void;
    /**
     ...
     * @returns Promise containing the websocket data
     */
    registerWebsocket(): Promise<Websocket>;
    /**
     * Register a websocket connection
     * @see advanced functionality, please use startNotifications or autostartNotifications instead
     *
     ...
     * @param callback A function that is passed the arguments (error, websocket)
     */
    registerWebsocket(callback: CallbackFn<Websocket>): void;
    /**
     ...
     * @param callback A function that is passed the arguments (error, websocket)
     */
    deleteWebsocket(callback: CallbackFn<void>): void;
    /**
