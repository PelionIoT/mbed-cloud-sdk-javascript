...
export class ConnectApi extends EventEmitter {
     ...
     */
    public mdsConnectedDevices(type?: string): Promise<Array<ConnectedDevice>>;
    /**
     * List connected devices from mDS **DEPRECATED**
     *
     * Example:
     ...
     * @param callback A function that is passed the arguments (error, devices)
     */
    public mdsConnectedDevices(type?: string, callback?: CallbackFn<Array<ConnectedDevice>>): void;
    public mdsConnectedDevices(type?: any, callback?: CallbackFn<Array<ConnectedDevice>>): Promise<Array<ConnectedDevice>> {
