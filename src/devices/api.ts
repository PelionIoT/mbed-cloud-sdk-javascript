...
export class Api {
    ...
    constructor(options: ConnectionOptions) {
        ...
        this.endpoints.setApiKey(EndpointsApiApiKeys.Bearer, "Bearer " + options.accessKey);
        this.notifications.setApiKey(NotificationsApiApiKeys.Bearer, "Bearer " + options.accessKey);
        this.resources.setApiKey(ResourcesApiApiKeys.Bearer, "Bearer " + options.accessKey);
        this.subscriptions.setApiKey(SubscriptionsApiApiKeys.Bearer, "Bearer " + options.accessKey);
        this.catalog.setApiKey(CatalogApiApiKeys.Bearer, "Bearer " + options.accessKey);
        this.query.setApiKey(QueryApiApiKeys.Bearer, "Bearer " + options.accessKey);
    }
}
