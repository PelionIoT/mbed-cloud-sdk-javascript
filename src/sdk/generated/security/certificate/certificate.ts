...
export class Certificate extends EntityBase {
    ...
    */
    ...
    /**
    * X509v3 trusted certificate in PEM format..
    */
    ...
    */
    ...
    /**
    * PEM format X509 developer certificate..
    */
    ...
    */
    ...
    /**
    * Content of the securityc file that will be flashed into the device to provide the security credentials.
    */
    ...
    * @param options filter options
    */
    public paginateList(options?: ListOptions): Paginator<Certificate, ListOptions> {
        const pageFunc = (pageOptions: ListOptions): Promise<ListResponse<Certificate>> => {
            return apiWrapper(resultsFn => {
                const { limit, after, order, include } = pageOptions as ListOptions;
                Client._CallApi<Certificate>({
