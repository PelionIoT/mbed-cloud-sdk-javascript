...
export const listPresubscriptions = (endpoints: Endpoints, callback?: CallbackFn<Array<PresubscriptionObject>>): Promise<Array<PresubscriptionObject>> => {
...
export const updatePresubscriptions = (endpoints: Endpoints, subscriptions: Array<PresubscriptionObject>, callback?: CallbackFn<void>): Promise<void> => {
    return apiWrapper(resultsFn => {
