...
export const getResourceValue = (connect: ConnectApi, endpoints: Endpoints, asyncFns, forceClear: boolean, autostartNotifications: boolean, deviceId: string, resourcePath: string, timeout?: number, mimeType?: any, callback?: CallbackFn<string | number | void>): Promise<string | number | void> => {
...
export const setResourceValue = (connect: ConnectApi, endpoints: Endpoints, asyncFns, forceClear: boolean, autostartNotifications: boolean, deviceId: string, resourcePath: string, value: string | number, timeout?: number, mimeType?: any, callback?: CallbackFn<AsyncResponse>): Promise<AsyncResponse> => {
    if (typeof timeout === "function") {
        callback = timeout;
        timeout = null;
    }
...
export const executeResource = (connect: ConnectApi, endpoints: Endpoints, asyncFns, forceClear: boolean, autostartNotifications: boolean, deviceId: string, resourcePath: string, payload?: any, timeout?: number, mimeType?: any, accepts?: string, callback?: CallbackFn<AsyncResponse>): Promise<AsyncResponse> => {
...
export const getResource = (endpoints: Endpoints, connect: ConnectApi, deviceId: string, resourcePath: string, callback?: CallbackFn<Resource>): Promise<Resource> => {
