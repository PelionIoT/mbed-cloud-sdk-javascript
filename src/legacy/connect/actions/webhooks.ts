...
export const updateWebhook = (connect: ConnectApi, endpoints: Endpoints, deliveryMethod: DeliveryMethod, connectForceClear: boolean, url: string, headers?: any, forceClear?: any, callback?: CallbackFn<void>): Promise<void> => {
    headers = headers || {};
