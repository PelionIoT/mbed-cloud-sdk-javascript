...
export class AccountAdminApi extends ApiBase {
     ...
     */
    public addApiKeyToGroups(
        apiKey: string,
        body: Array<string>,
        callback?: (error: any, data?: UpdatedResponse, response?: superagent.Response) => any,
    ...
    public addCertificate(
        ...
        callback?: (error: any, data?: TrustedCertificateResp, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
    ): superagent.SuperAgentRequest {
        // verify required parameter "body" is set
        if (body === null || body === undefined) {
    ...
    public createGroup(
        ...
        callback?: (error: any, data?: GroupSummary, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
    ): superagent.SuperAgentRequest {
        // verify required parameter "body" is set
        if (body === null || body === undefined) {
    ...
    public createUser(
        body: UserInfoReq,
        action?: string,
        callback?: (error: any, data?: UserInfoResp, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
    ): superagent.SuperAgentRequest {
        // verify required parameter "body" is set
        if (body === null || body === undefined) {
    ...
    public getAllUsers(
        ...
        statusIn?: string,
        statusNin?: string,
        callback?: (error: any, data?: UserInfoRespList, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
    ): superagent.SuperAgentRequest {
        const headerParams: any = {};
     ...
     * @param include Comma separated additional data to return. Currently supported: total_count
     */
    public getGroupsOfApikey(
        apiKey: string,
        limit?: number,
        after?: string,
        order?: string,
        include?: string,
        callback?: (error: any, data?: GroupSummaryList, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
    ): superagent.SuperAgentRequest {
        // verify required parameter "apiKey" is set
        if (apiKey === null || apiKey === undefined) {
    ...
    public updateMyAccount(
        ...
        callback?: (error: any, data?: AccountInfo, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
    ): superagent.SuperAgentRequest {
        // verify required parameter "body" is set
        if (body === null || body === undefined) {
...
export class AggregatorAccountAdminApi extends ApiBase {
     ...
     * @param body A list of IDs of the groups to be updated.
     */
    public addAccountApiKeyToGroups(
        accountID: string,
        apiKey: string,
        body: Array<string>,
        callback?: (error: any, data?: UpdatedResponse, response?: superagent.Response) => any,
    ...
    public addAccountCertificate(
        ...
        return this.request<TrustedCertificateResp>(
            {
                url: "/v3/accounts/{accountID}/trusted-certificates".replace(
                    "{" + "accountID" + "}",
                    String(accountID)
                ),
                method: "POST",
     ...
     * @param body A list of users and API keys to be added to the group.
     */
    public addSubjectsToAccountGroup(
        accountID: string,
        groupID: string,
        body: SubjectList,
        callback?: (error: any, data?: UpdatedResponse, response?: superagent.Response) => any,
    ...
    public createAccount(
        ...
        action?: string,
        callback?: (error: any, data?: AccountCreationResp, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
    ): superagent.SuperAgentRequest {
        // verify required parameter "body" is set
        if (body === null || body === undefined) {
     ...
     */
    public createAccountApiKey(
        accountID: string,
        body: ApiKeyInfoReq,
        callback?: (error: any, data?: ApiKeyInfoResp, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
    ): superagent.SuperAgentRequest {
        // verify required parameter "accountID" is set
        if (accountID === null || accountID === undefined) {
     ...
     */
    public deleteAccountCertificate(
        accountID: string,
        certId: string,
        callback?: (error: any, data?: any, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
     ...
     */
    public getAccountCertificate(
        accountID: string,
        certId: string,
        callback?: (error: any, data?: TrustedCertificateInternalResp, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
    ): superagent.SuperAgentRequest {
        // verify required parameter "accountID" is set
        if (accountID === null || accountID === undefined) {
    ...
    public getAllAccountApiKeys(
        ...
        keyEq?: string,
        ownerEq?: string,
        callback?: (error: any, data?: ApiKeyInfoRespList, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
    ): superagent.SuperAgentRequest {
        // verify required parameter "accountID" is set
        if (accountID === null || accountID === undefined) {
     ...
     */
    public getAllAccountCertificates(
        accountID: string,
        limit?: number,
        after?: string,
        order?: string,
        ...
        serviceEq?: string,
        expireEq?: number,
        deviceExecutionModeEq?: number,
        deviceExecutionModeNeq?: number,
        ownerEq?: string,
        enrollmentModeEq?: boolean,
        issuerLike?: string,
        subjectLike?: string,
        callback?: (error: any, data?: TrustedCertificateInternalRespList, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
    ): superagent.SuperAgentRequest {
        // verify required parameter "accountID" is set
        if (accountID === null || accountID === undefined) {
    ...
    public getAllAccounts(
        ...
        format?: string,
        properties?: string,
        callback?: (error: any, data?: AccountInfoList, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
    ): superagent.SuperAgentRequest {
        const headerParams: any = {};
     ...
     * @param include Comma separated additional data to return. Currently supported: total_count
     */
    public getApiKeysOfAccountGroup(
        accountID: string,
        groupID: string,
        limit?: number,
        after?: string,
     ...
     * @param include Comma separated additional data to return. Currently supported: total_count
     */
    public getGroupsOfAccountApikey(
        accountID: string,
        apiKey: string,
        limit?: number,
        after?: string,
     ...
     * @param body A list of IDs of the groups to be updated.
     */
    public removeAccountApiKeyFromGroups(
        accountID: string,
        apiKey: string,
        body: Array<string>,
        callback?: (error: any, data?: UpdatedResponse, response?: superagent.Response) => any,
     ...
     * @param body A list of IDs of the groups to be updated.
     */
    public removeAccountUserFromGroups(
        accountID: string,
        userId: string,
        body: Array<string>,
        callback?: (error: any, data?: UpdatedResponse, response?: superagent.Response) => any,
     ...
     * @param body
     */
    public removeApiKeysFromAccountGroup(
        accountID: string,
        groupID: string,
        body?: SubjectList,
        callback?: (error: any, data?: UpdatedResponse, response?: superagent.Response) => any,
     ...
     * @param body
     */
    public removeUsersFromAccountGroup(
        accountID: string,
        groupID: string,
        body?: SubjectList,
        callback?: (error: any, data?: UpdatedResponse, response?: superagent.Response) => any,
     ...
     */
    public resetAccountApiKeySecret(
        accountID: string,
        apiKey: string,
        callback?: (error: any, data?: ApiKeyInfoResp, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
     ...
     * @param body A trusted certificate object with attributes.
     */
    public updateAccountCertificate(
        accountID: string,
        certId: string,
    ...
    public updateAccountUser(
        ...
        userId: string,
        body: UserUpdateReq,
        callback?: (error: any, data?: UserUpdateResp, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
    ): superagent.SuperAgentRequest {
        // verify required parameter "accountID" is set
        if (accountID === null || accountID === undefined) {
     ...
     */
    public validateAccountUserEmail(
        accountID: string,
        userId: string,
        callback?: (error: any, data?: any, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
...
export class DeveloperApi extends ApiBase {
    ...
    public getAllCertificates(
        ...
        issuerLike?: string,
        subjectLike?: string,
        callback?: (error: any, data?: TrustedCertificateRespList, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
    ): superagent.SuperAgentRequest {
        const headerParams: any = {};
     ...
     * @param body A list of IDs of the groups to be updated.
     */
    public removeMyApiKeyFromGroups(
        body: Array<string>,
        callback?: (error: any, data?: UpdatedResponse, response?: superagent.Response) => any,
        requestOptions?: { [key: string]: any }
    ): superagent.SuperAgentRequest {
