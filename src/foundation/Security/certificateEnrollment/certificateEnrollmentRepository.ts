                    ...
                    this.client._CallApi(
                        {
                            ...
                            method: "GET",
                            query: {
                                device_id__eq: extractFilter(pageOptions.filter, "device_id", "eq"),
                                certificate_name__eq: extractFilter(pageOptions.filter, "certificate_name", "eq"),
                                enroll_status__neq: extractFilter(pageOptions.filter, "enroll_status", "neq"),
                                enroll_status__eq: extractFilter(pageOptions.filter, "enroll_status", "eq"),
                                enroll_result__neq: extractFilter(pageOptions.filter, "enroll_result", "neq"),
                                enroll_result__eq: extractFilter(pageOptions.filter, "enroll_result", "eq"),
                                created_at__lte: extractFilter(pageOptions.filter, "created_at", "lte"),
                                created_at__gte: extractFilter(pageOptions.filter, "created_at", "gte"),
                                updated_at__lte: extractFilter(pageOptions.filter, "updated_at", "lte"),
                                updated_at__gte: extractFilter(pageOptions.filter, "updated_at", "gte"),
