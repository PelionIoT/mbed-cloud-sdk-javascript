                    ...
                    this.client._CallApi(
                        {
                            ...
                            query: {
                                ...
                                last_operator_suspension_category__eq: extractFilter(
                                    pageOptions.filter,
                                    "lastOperatorSuspensionCategory",
                                    "eq"
                                ),
                                last_operator_suspension_category__neq: extractFilter(
                                    pageOptions.filter,
                                    "lastOperatorSuspensionCategory",
                                    "neq"
                                ),
                                last_operator_suspension_category__in: extractFilter(
                                    pageOptions.filter,
                                    "lastOperatorSuspensionCategory",
                                    "in"
                                ),
                                last_operator_suspension_category__nin: extractFilter(
                                    pageOptions.filter,
                                    "lastOperatorSuspensionCategory",
                                    "nin"
                                ),
                                last_operator_suspension_updated_at__in: extractFilter(
                                    pageOptions.filter,
                                    "lastOperatorSuspensionUpdatedAt",
                                    "in"
                                ),
                                last_operator_suspension_updated_at__nin: extractFilter(
                                    pageOptions.filter,
                                    "lastOperatorSuspensionUpdatedAt",
                                    "nin"
                                ),
                                last_operator_suspension_updated_at__lte: extractFilter(
                                    pageOptions.filter,
                                    "lastOperatorSuspensionUpdatedAt",
                                    "lte"
                                ),
                                last_operator_suspension_updated_at__gte: extractFilter(
                                    pageOptions.filter,
                                    "lastOperatorSuspensionUpdatedAt",
                                    "gte"
                                ),
                                ...
                                last_system_suspension_category__eq: extractFilter(
                                    pageOptions.filter,
                                    "lastSystemSuspensionCategory",
                                    "eq"
                                ),
                                last_system_suspension_category__neq: extractFilter(
                                    pageOptions.filter,
                                    "lastSystemSuspensionCategory",
                                    "neq"
                                ),
                                last_system_suspension_category__in: extractFilter(
                                    pageOptions.filter,
                                    "lastSystemSuspensionCategory",
                                    "in"
                                ),
                                last_system_suspension_category__nin: extractFilter(
                                    pageOptions.filter,
                                    "lastSystemSuspensionCategory",
                                    "nin"
                                ),
                                last_system_suspension_updated_at__in: extractFilter(
                                    pageOptions.filter,
                                    "lastSystemSuspensionUpdatedAt",
                                    "in"
                                ),
                                last_system_suspension_updated_at__nin: extractFilter(
                                    pageOptions.filter,
                                    "lastSystemSuspensionUpdatedAt",
                                    "nin"
                                ),
                                last_system_suspension_updated_at__lte: extractFilter(
                                    pageOptions.filter,
                                    "lastSystemSuspensionUpdatedAt",
                                    "lte"
                                ),
                                last_system_suspension_updated_at__gte: extractFilter(
                                    pageOptions.filter,
                                    "lastSystemSuspensionUpdatedAt",
                                    "gte"
                                ),
