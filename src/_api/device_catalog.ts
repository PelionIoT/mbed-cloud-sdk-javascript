...
export class DefaultApi extends ApiBase {
     ...
     * @param include Comma separated list of data fields to return. Currently supported: total_count
     */
    deviceEventList_1 (limit?: number, order?: string, after?: string, filter?: string, include?: string, callback?: (error:any, data?:DeviceEventPage, response?: superagent.Response) => any): superagent.SuperAgentRequest {
     ...
     * @param deviceEventId 
     */
    deviceEventRetrieve_2 (deviceEventId: string, callback?: (error:any, data?:DeviceEventData, response?: superagent.Response) => any): superagent.SuperAgentRequest {
        // verify required parameter "deviceEventId" is set
        if (deviceEventId === null || deviceEventId === undefined) {
            if (callback) {
                callback(new SDKError("Required parameter 'deviceEventId' missing."));
